...
<form method="POST" action="/send-regions">
	...
	<div class="form-group">
		<input name="subjectRegions" type="text" class="form-control" id="subjectRegions"
			value="{{$json['kraj']}}: Distribuce OOP dne {{$date}}" required>
	</div>
	<h4>Tělo e-mailu:</h4>
	<div class="form-group">
...
z rozhodnutí Vlády ČR budou pro {{$json['kraj']}} dne {{$date}} rozvezeny ochranné pomůcky, dle níže uvedeného rozpisu:
		</textarea>
	</div>
	<div class="form-group">
